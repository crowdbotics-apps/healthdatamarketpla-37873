...
## Project Structure
    ...
    ├── healthdatamarketpla_37873  # Django project configurations
...
1. Clone this repo and `cd healthdatamarketpla_37873`
...
2. Clone this repo and `cd healthdatamarketpla_37873`
